...
好きなサイトのURLを投げると、配信されている**本番バンドルをそのまま回収**して
[wakaru](https://github.com/pionxzh/wakaru) で分割・unminifyし、
「これwebpack 5製だな」「Reactのfiber実装が回ってる」みたいな**正体を勝手に暴いて表示**するツールです。
診断結果はそのままX (Twitter) にシェアできます。
